...
- Model 10 target accuracy hit / **Final Model**
  - Features used: all but type, videoamt, health
  - Confusion Matrix and Classification Report: <img src='https://github.com/trosie3/UofODataViz_Final_Project/blob/main/model%20images/finalmodelcrcm.png' width=75% height=75% align=left>
